...
- 状态栏正文：可选择用当前正文替换 Codex 状态栏图标；较长内容会在状态栏中自动翻页，可单独调整翻页速度，点击仍打开应用菜单。
...
- 阅读模式：在带实体 Touch Bar 的 Mac 上，可从状态栏选择文本文件进入夜读模式，支持 TXT、Markdown、Word 文档以及常见代码文件。
...
- 状态栏：可选的当前正文显示，会替换 Codex 图标并自动翻页长内容，并提供独立的翻页速度。
- 通用：暂停更新、立即刷新、退出。
